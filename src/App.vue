<template>
  <v-app>
    ...
    <v-content>
    <a href="https://github.com/lyonsbp/registertovote.how" target="_blank" rel="noopener" class="github-corner" aria-label="View source on GitHub">
      <!-- <svg width="80" height="80" viewBox="0 0 250 250" class="github-corner-svg" style="fill:#151513; color:#fff; position: absolute; bottom: 0; border: 0; right: 0;" aria-hidden="true"> -->
